...
<template>
  <div
    class="pointer-events-none fixed left-1/2 top-14 z-0 h-55 w-75 -translate-x-1/2 overflow-hidden opacity-40 [animation:drift_14s_ease-in-out_infinite] sm:left-auto sm:right-17.5 sm:top-24 sm:h-80 sm:w-110 sm:translate-x-0 sm:opacity-50 2xl:z-40 2xl:opacity-60"
    aria-hidden="true"
  >
