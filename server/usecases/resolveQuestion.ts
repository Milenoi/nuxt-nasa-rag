...
function buildPrompt(question: string, sources: RetrievedSource[], playful: boolean) {
    ...
    const rules = playful
        ? `- FIRST, before considering any answer, check for gibberish: if the search is random characters or repeated keyboard mashing with no recognisable word (like "asdfgh", "asdfasdfasd", "qwerty", "aaaa"), reply with exactly: NONSENSE :: followed by one short, cheeky Star Trek-flavoured line teasing what they typed. Any real word or name, even a proper noun like "thor", counts as a valid search, not gibberish. Do NOT judge whether the word is "astronomical", whether it is relevant is decided by the descriptions below, not by your own knowledge of the word.
...
- Otherwise open with one short Star Trek-flavoured line that shows you enjoyed the search, then answer using ONLY the descriptions below, keep it concise, and mention which picture(s) you used.`
        : `- FIRST, before considering any answer, check for gibberish: if the search is random characters or repeated keyboard mashing with no recognisable word (like "asdfgh", "asdfasdfasd", "qwerty", "aaaa"), reply with exactly NONSENSE and nothing else. Any real word or name, even a proper noun like "thor", counts as a valid search, not gibberish. Do NOT judge whether the word is "astronomical", whether it is relevant is decided by the descriptions below, not by your own knowledge of the word.
