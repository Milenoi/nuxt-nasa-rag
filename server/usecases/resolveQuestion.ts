...
export async function resolveQuestion(question: string, playful: boolean, deps: Deps): Promise<AskResult> {
    ...
    const raw = await deps.model.generate(buildPrompt(question, sources, playful))
